...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (apiURL) {
	  var ajax = __webpack_require__(20)(apiURL);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var timeHTML = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  divideTimeHTML: function divideTimeHTML(time) {
	    ...
	    var hours = pad(divideTime(time, 60 * 60));
	    var minutes = pad(divideTime(time - hours * (60 * 60), 60));
	    var seconds = pad(divideTime(time - hours * (60 * 60) - minutes * 60));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (apiURL) {
	  var utils = __webpack_require__(17)(apiURL);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (apiURL) {
	  ...
	  var createTask = __webpack_require__(23)(apiURL);
	  ...
	  $container.on('submit', '#save-task', function (event) {
	    ...
	    var getTasks = __webpack_require__(20)(apiURL).getTasks;
